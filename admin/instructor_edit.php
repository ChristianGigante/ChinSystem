<?php
	...
	$firstname = $request['firstname']; //get the date of birth from collected data above
	...
	$dbname = "apsystem"; // set the table name
	...
	$sql = "UPDATE instructors SET firstname='".$firstname."', lastname='".$lastname."' WHERE id='".$id."'";
